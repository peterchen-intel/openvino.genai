...
InputsEmbedderQwen2_5_VL::InputsEmbedderQwen2_5_VL(
    ...
    InputsEmbedderQwen2VL(vlm_config, model_dir, device, core, device_config) {}
...
InputsEmbedderQwen2_5_VL::InputsEmbedderQwen2_5_VL(
    ...
    const std::shared_ptr<ov::Core>& core,
    const ov::AnyMap device_config) :
    InputsEmbedderQwen2VL(vlm_config, models_map, tokenizer, config_dir_path, device, core, device_config) {}
